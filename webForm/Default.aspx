...
<asp:Content ID="Content2" ContentPlaceHolderID="Body" runat="server">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="carousel-caption">
                    <h1 style="text-shadow: 0px 3px 4px black;">Student Market</h1>
                    <h3 style="text-shadow: 0px 3px 4px black;">Log in or register to buy or sell used books</h3>
                </div>
                <% } else { %>
                <div class="carousel-caption">
                    <h1 style="text-shadow: 0px 3px 4px black;">Welcome to Student Market</h1>
                    <h3 style="text-shadow: 0px 3px 4px black;">Browse ads from your fellow students or create your own!</h3>
                </div>
                <% } %>
            </div>
        </div>
    ...
    <div><br /></div>
        ...
        <div class="container text-center">
            <h3 style="color:cornflowerblue;">About Student Market</h3>
            <br>
            <div class="row" style="color:grey">
                <div class="card">
                    <div class="col-lg-4 col-md-4 col-sm-10 col-xs-12">
                        ...
                        <p style="text-align:left;line-height:175%;">We are a group of 5 students who had trouble finding study-related books for a cheap price. 
                            Therefore we thought that making "Student Market", a marketplace for selling and buying used school books, would be a suitable solution. 
                ...
                <div class="col-lg-4 col-md-4 col-sm-10 col-xs-12">
                    ...
                    <p style="text-align:left;line-height:175%;">Make money of your old books and help out other students! Money doesn't grow on trees for students, but the book list for each semester certainly does. 
                ...
                <div class="col-lg-4 col-md-4 col-sm-10 col-xs-12">
                    ...
                    <div class="well">
                        <p><b>How to use this page</b></p>
                        <p>Browse ads from your fellow students or create your own!</p>
                    </div>
